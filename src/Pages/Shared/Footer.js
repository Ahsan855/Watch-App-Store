...
const Footer = () => {
  return (
    <footer
      className="footer p-10 bg-secondary text-primary"
    >
      <div>
      ...
      <div className='max-w-screen-xl mx-auto px-4'>
        ...
        <div className='text-center pt-10 sm:pt-12 font-semibold flex items-center justify-center'>
          All Rights Reserved By &copy; Watches | 2022-2026
        </div>
      </div>
    </footer>
    </footer>
